...
goto home
:home
title Windows 10/11_(線上/離線軟體工具包)_v2025.1
echo ========================================================================================================
echo                                              --- 內含軟體 --- 
echo.
...
echo.
echo 華碩輸入法、NanaZip(win11)、YouTube Music、Win10/11更換桌布.鎖定畫面.關於Windows圖片、Copilot
echo ========================================================================================================
...
echo =========================================================================================================
echo.
echo 【1】關閉 UserChoice Protection Driver 「UCPD服務」    【10】隱藏/停用 Windows 10 部分功能  
echo.
echo 【2】開啟 UserChoice Protection Driver 「UCPD服務」    【11】新增/移除 右鍵管理員取得所有權
echo.
echo 【3】隱藏 Windows 11 工作列的小工具(關閉UCPD服務)      【12】使用者帳戶控制設定調整(UAC調整)
echo.
echo 【4】顯示 Windows 11 工作列的小工具(關閉UCPD服務)      【13】Windows 10 (更換桌布、關於Windows、版權文字)
echo.
echo 【5】隱藏 Windows 10 工作列的小工具(關閉UCPD服務)      【14】Windows 11 (更換桌布、關於Windows、版權文字)
echo.
echo 【6】顯示 Windows 10 工作列的小工具(關閉UCPD服務)      【15】啟用 NET Framework 3.5
echo.
echo 【7】停用 Windows 11 OverlayMinFPS                     【16】公用網路切換私人網路     
echo.
echo 【8】移除 Windows 11 OverlayMinFPS                     【17】私人網路切換公用網路
echo.
echo 【9】隱藏/停用 Windows 11 部分功能                     【18】回上一頁
echo.
echo ========================================================================================================
echo             --- ☆Dream-NAS☆ 個人網站 Dream 整合製作 ( https://dreamnas.familyds.com ) ---
echo.
...
if "%c15%"=="12" goto uac
if "%c15%"=="13" goto Widgets11
if "%c15%"=="14" goto Widgets12
if "%c15%"=="15" goto Widgets13
if "%c15%"=="16" goto Widgets14
if "%c15%"=="17" goto Widgets15
if "%c15%"=="18" goto Install
...
:Widgets11
cls
echo Windows 10 (更換桌布、關於Windows、版權文字)
cd /d "%BasePath%"軟體工具包\reg\win10
start /wait win10替換圖片.bat
goto Widgets

:Widgets12
cls
echo Windows 11 (更換桌布、關於Windows、版權文字)
cd /d "%BasePath%"軟體工具包\reg\win11
start /wait win11替換圖片.bat
goto Widgets
...
echo 已安裝完成
echo.
echo 安裝 MicrosoftVCLibsUWPDesktop
PowerShell -Command "Add-AppxPackage -Path '%BasePath%軟體工具包\軟體\MicrosoftVCLibs.Appx'"
echo 已安裝完成
echo.
echo 安裝 MicrosoftVCLibs
PowerShell -Command "Add-AppxPackage -Path '%BasePath%軟體工具包\軟體\MicrosoftVCLibs1.Appx'"
echo 已安裝完成
echo.
echo 安裝 WindowsAppRuntime
PowerShell -Command "Add-AppxPackage -Path '%BasePath%軟體工具包\軟體\MicrosoftWindowsAppRuntime.msix'"
echo 已安裝完成
echo.
echo 安裝 Copilot
PowerShell -Command "Add-AppxPackage -Path '%BasePath%軟體工具包\軟體\MicrosoftCopilot.AppxBundle'"
echo.
echo 建立 Copilot桌面圖示
set "ShortcutName=Microsoft Copilot.lnk"
set "ShortcutPath=%USERPROFILE%\Desktop\%ShortcutName%"
set "TargetApp=shell:AppsFolder\Microsoft.Copilot_8wekyb3d8bbwe!App"
