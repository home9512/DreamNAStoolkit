...
# 設定下載 URL 和儲存路徑
$FilePack = @(
	"Cuteversion_Software_Toolkit_Windows_10_11_v2026.exe",
	"Software_Toolkit.zip",
	"7z.zip"
)
$FileHash = @(
	"8d121246c9c17e7bbdb4193eb0536283bd1bcbdb4f54d1536a834480562e2715",
	"86760eeed45205bc06710771e669391f4667f69c467e01f44e180911ec58661c",
